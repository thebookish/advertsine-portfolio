 ...
 -z-10 h-full w-full bg-[#fafafa]
  ...
  duration-200
     hover:shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)] "
      ...
      <div className="px-6 md:px-0 mx-auto mt-24 max-w-screen-xl text-center ">
  ...
  <div className="mt-10 flex flex-col md:flex-row justify-center items-center gap-4">
    ...
    <BoxReveal boxColor="#3b82f6" duration={0.5}>
      <p className="md:text-xl font-semibold flex gap-x-2 md:gap-x-4 items-center">
        ...
        Strategy
          ...
          <div className="md:flex flex-col md:flex-row items-center justify-between text-center md:text-left gap-y-10 my-10 gap-x-28 mx-auto">
    <div className="md:w-2/5 w-full">
      <h1 className="text-2xl font-medium text-gray-600 w-full md:w-4/5">
    ...
    <section className="overflow-hidden mt-10 w-full md:w-4/5">
      <InfiniteMovingLogos
        speed="slow"
        direction="left"
        items={[
  ...
  <div className="flex flex-col items-center justify-center gap-y-3 xl:w-4/5 2xl:w-[68%] mx-auto text-center">
  ...
  <div className="flex flex-col items-center md:flex-row md:justify-center md:gap-x-4 mt-10 text-center text-gray-600">
    <span>© 2025 Advertsine. All Rights Reserved.</span>
    <Link href="/" className="text-blue-500 mt-2 md:mt-0">
      Privacy Policy
    </Link>
  </div>
</footer>
